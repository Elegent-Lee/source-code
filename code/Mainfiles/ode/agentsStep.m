function [ simulationObj ] = agentsStep( simObj, settings,counter)
...
tic;
[tVec, odeAgents] = ode23(@(t,y)odeRhs(t,y,settings,simObj,counter),[t,t+dt],odeVec,odeOptions); %solve ODE with 'ode23'
t_ode = toc;
...
simObj.circles=[agents,settings.r];
simulationObj.circles = simObj.circles;
