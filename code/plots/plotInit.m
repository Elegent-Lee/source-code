...
if strcmp(settings.SimMode, 'algorithm2') || strcmp(settings.SimMode, 'algorithm3') %This paper is part of Algorithm 2 
%Plot Gamma Agent
...
hGamma = plot(gamma_agent(1),gamma_agent(2),'ro','MarkerFaceColor','r');
...
%daspect([1,1,1]);
% plot circles%%%%%%%%%%%%%%%%%%%%%
    [hcircles] = plotcircles(simulationObj.circles);
    plotObj.hcircles = hcircles;
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
daspect([1,1,1])
%axis auto;
grid on;
